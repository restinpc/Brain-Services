...
# news_index_updater.py — лежит рядом с server.py в папке 35/
...
CTX_TABLE     = "vlad_news_context_idx"    # NER fingerprints + occurrence_count
WEIGHTS_TABLE = "vlad_news_weights_table"  # все возможные weight_codes
CTX_MAP_TABLE = "vlad_news_ctx_map"        # news_id → ctx_id + news_date
...
class NewsWeightsService(BaseBrainService):
    """
    Сервис весов для новостного NER-контекста.
