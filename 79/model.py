"""
Algorithmic news topic/event model for services 79.
...
ALGO_VERSION = "tfidf-nmf-svd-hierkmeans-causal-v2"
...
def _transform_rows(rows: list[dict[str, Any]], artifact: dict[str, Any], cfg: dict[str, Any]):
    ...
    W = artifact["nmf"].transform(X).astype(np.float32, copy=False)
    sums = W.sum(axis=1)
